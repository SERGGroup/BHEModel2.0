...
hs_geometry_vert.nu_fixed = 262
hs_geometry_horiz.nu_fixed = 262
...
RES_FOLDER = os.path.join(
    ...
    "WP2", "Task2.3", "0 - Resources", "output", "nu_analysis"

)

file_path = os.path.join(RES_FOLDER, "base_case_nu_calculations.xlsx")
data_exporter = {
