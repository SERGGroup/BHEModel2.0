...
RES_FOLDER = os.path.join(
    ...
    "Well Calculations", "CO2-Based"

)

file_path = os.path.join(RES_FOLDER, "horizontal well - gradient curves - depth={}.xlsx".format(depth))
...
for i in range(len(time_points)):
    ...
    df_dict.update({
        ...
        "rho_dh_{}".format(t): rho_dh_list_ovr[:, i]
